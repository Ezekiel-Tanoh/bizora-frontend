...
export default function Pricing() {
  ...
  return (
    <>
      ...
      {/* ✅ CORRECTION PRINCIPALE : fond sombre + couleur blanche + padding */}
      <div style={{
        background: "#0a0a0f",
        minHeight: "100vh",
        color: "#fff",
        ...
        <div style={{ position: "relative", zIndex: 1 }}>
          ...
          <div style={{ textAlign: "center", marginBottom: "3rem" }}>
            <h1 style={{ fontSize: "1.8rem", fontWeight: "700", margin: "0 0 0.5rem", color: "#fff" }}>
                ...
                >
                  {plan.badge && !estActuel && (
                    <div style={{
                      ...
                      padding: "4px 16px", borderRadius: "100px", color: "#fff",
                  ...
                  <button
                    ...
                    style={{
                      ...
                      border: estActuel ? "1px solid rgba(52,211,153,0.3)" : "none",
          ...
          <div style={{ maxWidth: "700px", margin: "0 auto", textAlign: "center" }}>
            <h2 style={{ fontSize: "1.3rem", fontWeight: "700", marginBottom: "0.5rem", color: "#fff" }}>Des questions ?</h2>
            ...
            {success ? (
              <div style={{ textAlign: "center", padding: "1rem 0" }}>
                ...
                <div style={{ background: "rgba(139,92,246,0.08)", border: "1px solid rgba(139,92,246,0.2)", borderRadius: "12px", padding: "1rem", marginBottom: "1.5rem" }}>
                  <p style={{ fontSize: "1.4rem", fontWeight: "700", color: "#a78bfa", margin: "0 0 4px" }}>{montant.toLocaleString()} FCFA</p>
                  <p style={{ fontSize: "12px", color: "rgba(255,255,255,0.35)", margin: 0 }}>Plan {planSelectionne.nom} — {annuel ? "Annuel" : "Mensuel"}</p>
                </div>
                {paymentUrl && (
              ...
              <>
                ...
                <div style={{ background: planSelectionne.id === "pro" ? "rgba(139,92,246,0.08)" : "rgba(245,158,11,0.08)", border: `1px solid ${planSelectionne.id === "pro" ? "rgba(139,92,246,0.2)" : "rgba(245,158,11,0.2)"}`, borderRadius: "12px", padding: "1rem", marginBottom: "1.5rem" }}>
                  ...
                  <p style={{ fontSize: "1.6rem", fontWeight: "700", color: planSelectionne.id === "pro" ? "#a78bfa" : "#f59e0b", margin: "0 0 4px" }}>{montant.toLocaleString()} FCFA</p>
                  <p style={{ fontSize: "12px", color: "rgba(255,255,255,0.35)", margin: 0 }}>Plan {planSelectionne.nom} — {annuel ? "Annuel" : "Mensuel"}</p>
                </div>
