    ...
    <>
      ...
      <div style={{ color: "#fff", fontFamily: "'Inter', sans-serif" }}>
        ...
        <div style={{ marginBottom: "2rem" }}>
          ...
          <p style={{ fontSize: "14px", color: "rgba(255,255,255,0.4)", margin: "4px 0 0" }}>Votre assistant business intelligent</p>
        </div>
        ...
        <div style={cardStyle}>
          ...
          <div style={{ display: "flex", gap: "8px" }}>
            <input
              ...
              style={{ flex: 1, padding: "10px 14px", borderRadius: "10px", background: "rgba(255,255,255,0.05)", border: "1px solid rgba(255,255,255,0.1)", color: "#fff", fontSize: "13px", outline: "none" }}
